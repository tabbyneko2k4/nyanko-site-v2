        ...
        <div className="container mx-auto px-4 py-12">
            ...
            <div className="glass-card p-8 text-center mb-8">
              ...
              <div className="flex flex-wrap justify-center gap-4">
                <a
                  ...
                  className="group flex items-center gap-2 px-6 py-3 bg-primary/90 hover:bg-primary text-primary-foreground rounded-lg transition-all duration-300 hover:scale-105 shadow-lg"
                >
                  <FaTrello
                    className={`h-5 w-5 transition-colors duration-300 group-hover:text-[${trelloColor}]`}
                  />
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group flex items-center gap-2 px-6 py-3 bg-secondary hover:bg-secondary/80 text-secondary-foreground rounded-lg transition-all duration-300 hover:scale-105 shadow-lg"
                >
                  <SiFiverr
                    className={`h-5 w-5 transition-colors duration-300 group-hover:text-[${fiverrColor}]`}
                  />
                      ...
                      {detailKeys.map((key) => (
                        <Fragment key={key}>
                          <div className="font-semibold text-muted-foreground">
                            {content.pricing.detailLabels[key]}:
                          </div>
                ...
                {content.workflow.stages.map((stage, index) => (
                  <div key={index} className="mb-12 relative">
                    ...
                    <div className="glass-card p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
                      <h3 className="text-xl font-gaming mb-4 text-primary">
                        {stage.title}
                      </h3>
          ...
          <div className="animate-content-enter [animation-delay:1200ms]">
            ...
            <div className="max-w-4xl mx-auto">
              <Accordion
                type="multiple"
                className="w-full glass-card p-6 space-y-2"
              >
      ...
      <div className="fixed bottom-4 right-4 z-50 flex flex-col items-center gap-3">
        {isScrollTopVisible && (
          <Button
            ...
            className="bg-background/80 backdrop-blur-sm hover:bg-primary/20 h-11 w-11 rounded-full animate-in fade-in"
          >
...
export default MusicCommission;
