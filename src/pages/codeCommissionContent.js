export const codeCommissionContent = {
  en: {
    pageTitle: { main: "CHAT CODE", highlight: "COMMISSIONS" },
    intro:
      "Need a custom chat widget, event overlay, or other interactive elements for your stream? Let's build something functional and beautiful together!",
    buttons: {
    ...
    tos: {
      ...
      sections: [
        ...
        },
        {
          ...
          points: [
            "The complete product will be delivered to the client upon completion, depending on the service type.",
            "Delivery Formats:\n- **Design assets (Stream Schedule, Overlays, Logo):** For Stream Schedules, a .psd file will be delivered. For other assets, .png and .svg (if applicable) files will be delivered via Google Drive.\n- **Code assets (Chat Widget):** All necessary files, including .html, .css, and .js, will be delivered as text files via Google Drive.",
            ...
            "**Basic Commercial License (Free):**\n- Use the product for social media profiles, banners, or direct image sharing.\n- Use the product for livestreams or in non-profit videos.\n- When using the product, the client must credit the creator.",
            "**Commercial License 1 (+50% of product value):** Includes all rights from the Basic License, plus:\n- Use for promotion and direct revenue generation (e.g., sponsored posts, event/merch advertisements).\n- Use for personal branding elements (panels, logos, emotes, overlays, stingers).",
            "**Commercial License 2 (+100% of product value):** Includes all rights from Commercial License 1, plus:\n- Production of digital goods (Patreon, Memberships, artwork for music releases, digital wallpapers, etc.).\n- Production of physical goods (keychains, cards, badges, etc.).",
          ],
        },
        {
    ...
    faq: [
      ...
      },
      {
        ...
        a: "It depends on the service. For design assets like overlays or logos, you'll get high-quality .png, .svg, or .psd files. For code commissions like chat widgets, you'll receive all the necessary .html, .css, and .js files along with setup instructions.",
      },
      {
        q: "What can I use the final product for? Is commercial use included?",
        a: "A Basic Commercial License is included for free, allowing use on social media and non-profit streams (with credit). For promotional use or personal branding (logos, emotes), you need Commercial License 1 (+50% fee). For selling digital or physical merchandise, you need Commercial License 2 (+100% fee). Please see Section B of our ToS for full details.",
      },
      {
        q: "Can I edit the files myself after delivery?",
        a: "No, the product may not be altered by you or a third party without our written consent. This is to ensure the integrity of the work. If you need changes, please contact us.",
      },
      {
        q: "Who owns the rights to the final product?",
        a: "The Studio retains the full intellectual property rights to the code and design. When you commission a piece, you are purchasing a license to use it according to the agreed-upon terms. We also reserve the right to use the product in our portfolio.",
      },
      {
        q: "What is your refund policy?",
        a: "Our refund policy is based on the project's progress: a 100% refund is available if we haven't started. If work has begun, the deposit is non-refundable. Please refer to Section D of our Terms of Service for a detailed breakdown.",
      },
      {
        q: "Will my project be kept confidential?",
        a: "Your personal information is always kept confidential. However, we reserve the right to share work-in-progress on social media. If your project requires complete secrecy, please request a Non-Disclosure Agreement (NDA) before we begin.",
      },
    ],
  },
  vi: {
    ...
    faq: [
      ...
      },
      {
        ...
        a: "Tùy thuộc vào dịch vụ. Đối với các sản phẩm thiết kế như overlay hay logo, bạn sẽ nhận được file chất lượng cao như .png, .svg, hoặc .psd. Đối với các sản phẩm code như widget chat, bạn sẽ nhận được toàn bộ file .html, .css, .js cần thiết cùng với hướng dẫn cài đặt.",
      },
      {
      ...
      },
      {
        ...
        a: "Không, sản phẩm không được tự ý chỉnh sửa bởi bạn hoặc bên thứ ba nếu không có sự đồng ý bằng văn bản từ chúng tôi. Điều này nhằm đảm bảo tính toàn vẹn của sản phẩm. Nếu bạn cần thay đổi, vui lòng liên hệ với chúng tôi.",
      },
      {
        q: "Ai sở hữu bản quyền của sản phẩm cuối?",
        a: "Studio giữ toàn quyền sở hữu trí tuệ đối với mã nguồn và thiết kế. Khi bạn đặt hàng, bạn đang mua giấy phép để sử dụng nó theo các điều khoản đã thỏa thuận. Chúng tôi cũng có quyền sử dụng sản phẩm trong portfolio của mình.",
      },
      {
